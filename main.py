...
print("List of all members with no duplicate\n" + str([ele for ele in D3]))
listSet = list(com_set)
listSet.extend(list(D3))

print("\nList of both sets enabled duplicate record:")
print(listSet)
printLine()


# I'm not sure about list down all the members in D1 and D2, does it mean allow